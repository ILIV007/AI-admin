...
const translations: Record<UiLanguage, Record<string, string>> = {
  en: {
    ...
    "sched.enabled": "🟢 Schedule is ON",
    "sched.disabled": "⚪ Schedule is OFF",
    "sched.posts_per_day": "Posts per day",
    "sched.start_hour": "Start",
    "sched.tehran": "",
    "sched.occupied": "occupied",
    "sched.distribute_info": "Posts are randomly distributed across free slots. When today's slots are full, the post rolls to tomorrow.",
    "sched.weekly_title": "📅 Weekly Calendar",
    "sched.today": "Today",
    "sched.clear_all": "🗑️ Clear All Scheduled",
    "sched.clear_confirm": "⚠️ Are you sure you want to delete ALL scheduled posts? This cannot be undone.",
    "sched.clear_confirm_yes": "✅ Yes, delete all",
    "sched.clear_confirm_no": "❌ Cancel",
    "sched.clear_done": "✅ All scheduled posts deleted.",
    "sched.clear_empty": "No scheduled posts to delete.",
    "sched.clear_count": "{count} post(s) deleted.",
    ...
    "queue.note": "Cron processes this queue every 30 minutes.",
  ...
  fa: {
    ...
    "sched.title": "📅 برنامه زمان‌بندی",
    "sched.enabled": "🟢 زمان‌بندی فعال",
    "sched.disabled": "⚪ زمان‌بندی غیرفعال",
    "sched.posts_per_day": "پست در روز",
    "sched.start_hour": "شروع",
    "sched.tehran": "",
    "sched.occupied": "پر",
    "sched.distribute_info": "پست‌ها به‌صورت تصادفی در اسلات‌های آزاد پخش می‌شوند. وقتی اسلات‌های امروز پر شود، پست به فردا منتقل می‌شود.",
    "sched.weekly_title": "📅 برنامه هفتگی",
    "sched.today": "امروز",
    "sched.clear_all": "🗑️ پاک کردن همه پست‌های زمان‌بندی‌شده",
    "sched.clear_confirm": "⚠️ مطمئن هستید که می‌خواهید تمام پست‌های زمان‌بندی‌شده را حذف کنید؟ این عمل قابل بازگشت نیست.",
    "sched.clear_confirm_yes": "✅ بله، همه را پاک کن",
    "sched.clear_confirm_no": "❌ لغو",
    "sched.clear_done": "✅ تمام پست‌های زمان‌بندی‌شده پاک شدند.",
    "sched.clear_empty": "هیچ پست زمان‌بندی‌شده‌ای برای پاک کردن وجود ندارد.",
    "sched.clear_count": "{count} پست پاک شد.",
    "sched.tomorrow": "فردا",
