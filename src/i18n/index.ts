...
const translations: Record<UiLanguage, Record<string, string>> = {
  en: {
    ...
    "sched_report.title": "📅 Scheduled Post Published",
    "sched_report.details": "📋 Details",
    "sched_report.scheduled_for": "Scheduled for",
    "sched_report.published_at": "Published at",
    "sched_report.delay": "Delay",
    "sched_report.parts": "Parts",
    "sched_report.ai_used": "AI Used",
    "sched_report.no_ai": "No AI",
    "sched_report.job_id": "Job ID",
    "sched_report.channel_msgs": "Channel messages",
    "sched_report.delay_unit": "min",
  ...
  fa: {
    ...
    "sched_report.title": "📅 پست زمان‌بندی‌شده منتشر شد",
    "sched_report.details": "📋 جزئیات",
    "sched_report.scheduled_for": "زمان‌بندی",
    "sched_report.published_at": "انتشار",
    "sched_report.delay": "تأخیر",
    "sched_report.parts": "بخش‌ها",
    "sched_report.ai_used": "هوش مصنوعی",
    "sched_report.no_ai": "بدون AI",
    "sched_report.job_id": "شناسه",
    "sched_report.channel_msgs": "پیام‌های کانال",
    "sched_report.delay_unit": "دقیقه",
